...
int i=0,num, ndd,ver,res,x=0,y=0;
...
client *auxp1;
 ...
 printf("\nBEM VINDO AO CHAMP\n");
    ...
    while (argc!=6){
    printf("\nFaltam Parametros!\n Parametros esperados ./servidor -d  <duracao> -t <tempo_espera> ./diretoria\n");
    return 0;
    } 
...
s_fifo_fd = open(CHAMP_FIFO, O_RDWR);
 ...
 ver = Verifica_player(players, cli1.pnome);
    ...
    if(ver == 1){
        ...
        auxp1 = devolve_player(players,i);
        i++;
        pthread_create(&auxp1->tid,NULL,func1,auxp1);
